...
class Param:
    def __init__(self):
        ...
        self.parser.add_argument('--policy_type', type=str, default="v0", help="policy_type is fixed to v0 in AeroForesee")
        self.parser.add_argument('--collect_type', type=str, default="TF", help="environment supervision mode in [TF, dagger]")
...
# args.policy_type = 'v0'
assert args.policy_type in ['v0'], 'policy_type error'
